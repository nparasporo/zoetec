...
# -vf "drawtext=text='%{localtime\:%T}':fontsize=48:fontcolor=white:box=1:boxcolor=black@0.7:x=w-text_w:y=h-text_h-1040"
ffplay  udp://:4441 -f mjpeg -framerate 30 -x 1920 -y 1080
